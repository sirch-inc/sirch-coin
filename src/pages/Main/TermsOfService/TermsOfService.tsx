  ...
  return (
    <div className='terms-of-service'>
      ...
      <ol>
        ...
        These Terms shall be governed by and construed in accordance with the laws of the State of Colorado. Any disputes arising under or in connection with these Terms shall be resolved through binding arbitration conducted under the rules of the <a target='_blank' href='https://www.adr.org/' rel="noreferrer">American Arbitration Association</a> (referred to as the &quot;AAA&quot;).
        </li>
      </ol>
      <p>
